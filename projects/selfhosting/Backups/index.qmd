...
**On docker node:** 1. Stop all containers for a service 2. Snapshot the service directory 3. Start all containers for a service 4. Transfer the snapshot to the [control node](../nodes/controller/)

**On control node:** 6. Checksum snapshot 7. Create Compressed tarball 8. Verify backup validity
